...
export const EditArrangementForm = ({ currentUser }) => {
    ...
    const fetchAllData = () => {
        ...
        getFlowersByArrangementId(Number(arrangementId)).then(async (flowersArray) => {
    ...
    const handleArrangementSave = async (event) => {
        ...
        // Step 1: Generate Image using Open Ai
        ...
        updatedArrangement.img = cloudinaryUrl
    ...
    return <>
        {/* Show All Flowers Button (Resets searches) */}
        {
            loading ?
                ...
                <>
                    {/* Header Information */}
                    <div className="container m-auto mt-8 p6">
                        ...
                        <hr className="w-200 mx-auto mt-1 mb-4 border-2 border-green-800" />
                    </div>
