...
export const Flower = ({ flowerObj }) => { //fetchAndSetAllFlowers
    ...
    return <>
        <div className="max-w-lg bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden">
            {/* Image */}
            <img src={flowerObj.img} alt="Card Image" className="aspect-square w-full object-cover" />
